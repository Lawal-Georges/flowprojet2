"use client"
import { getProjectInfo, getTaskDetails, updateTaskStatus } from '../../actions';
...
const Page = ({ params }: { params: Promise<{ taskId: string }> }) => {
    ...
    const fetchInfos = React.useCallback(async (taskId: string) => {
        try {
            ...
            {task ? (
                <div>
                    ...
                    <div className='flex justify-between items-center mb-4'>
                        ...
                        <div>
                            <label htmlFor="status-select" className="sr-only">Changer le statut</label>
                            <select
                                id="status-select"
                                value={status}
