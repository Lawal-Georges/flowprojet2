...
const Page = ({ params }: { params: Promise<{ projectId: string }> }) => {
  ...
  const fetchInfos = async (projectId: string) => {
    try {
      ...
      console.error("Erreur lors du chargement du project:", error);
    }
  };
  ...
  // Juste pour éviter les erreurs de variables non utilisées :
  useEffect(() => {
      ...
      <div className="md:flex md:flex-row flex-col">
        ...
        <div className="mt-6 md:ml-6 md:mt-0 md:w-3/4">
          <div className="md:flex md:justify-between">
            ...
            <Link href={`/new-task/${projectId}`} className="btn btn-sm mt-2 md:mt-0">
              Nouvelle tache
